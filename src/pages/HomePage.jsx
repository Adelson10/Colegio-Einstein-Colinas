...
function Footer() {
  return <footer className="relative overflow-hidden bg-primary text-primary-foreground pt-14 pb-8">
            ...
            <img src="/leaoazul.png" alt="" aria-hidden="true" className="pointer-events-none select-none absolute right-0 top-0 h-full w-auto object-contain opacity-10 translate-x-1/4 scale-125" />
            ...
            <img src={LOGO} alt="" aria-hidden="true" className="pointer-events-none select-none absolute z-10 -bottom-[1vw] inset-x-0 mx-auto h-[10vw] w-[10vw] object-contain brightness-0 invert opacity-25 [mask-image:linear-gradient(to_bottom,white,white_50%,transparent_100%)]" />
        </footer>;
}
